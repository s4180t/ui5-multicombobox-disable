		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5multicomboboxdisable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5multicomboboxdisable-display": {
								"semanticObject": "ui5multicomboboxdisable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5multicomboboxdisable",
									"url": sap.ui.require.toUrl("ui5multicomboboxdisable")
								}
							}
						}
					}
